#!/usr/bin/env bash
# Parallel, resumable Haworth localization pipeline.
#
...
if (( $# > 0 )); then
    case "$1" in
        -h|--help)
            echo "Usage: ./run_haworth_parallel_pipeline.sh"
...
echo "Haworth parallel localization pipeline"
...
echo
echo "Haworth parallel pipeline completed."
...
echo "The 10 m profile is preprocessed but excluded from localization because"
echo "its global catalogue cannot form a three-feature DARCES control triangle."
